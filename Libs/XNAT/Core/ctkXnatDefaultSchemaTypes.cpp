...
QString ctkXnatDefaultSchemaTypes::XSI_IMAGE_SESSION = "xnat:imageSessionData";
QString ctkXnatDefaultSchemaTypes::XSI_SUBJECT_VARIABLES_DATA = "xnat:subjectVariablesData";
